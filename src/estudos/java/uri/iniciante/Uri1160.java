...
//	de duas cidades quaisquer (A e B), ela gostaria de saber quantos anos levará para que a cidade menor 
//	(sempre é a cidade A) ultrapasse a cidade B em população. Claro que ela quer saber apenas para as cidades 
//	cuja taxa de crescimento da cidade A é maior do que a taxa de crescimento da cidade B, portanto, previamente 
//	já separou para você apenas os casos de teste que tem a taxa de crescimento maior para a cidade A. Sua 
//	tarefa é construir um programa que apresente o tempo em anos para cada caso de teste.
//	
...
//	100 pessoas resultará em 102 pessoas, e não 102.5 pessoas, enquanto um crescimento de 2.5% sobre uma 
//	população de 1000 pessoas resultará em 1025 pessoas. Além disso, não utilize variáveis de precisão simples
